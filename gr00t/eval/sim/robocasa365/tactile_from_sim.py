"""Online gripper tactile extraction from RoboCasa / robosuite sim (eval rollout)."""
...
TACTILE_OBS_KEYS = ("tactile.left", "tactile.right", "tactile.contact")
...
def extract_gripper_tactile_frame(
    ...
    """Read pad-only normal forces; contact follows dataset threshold logic."""
