...
# with native AlternateVLDiT + per-component CategorySpecificMLP decoders + STSS/MOSS.
set -euo pipefail
...
OUTPUT_DIR="${OUTPUT_DIR:-$PROJECT_ROOT/output/rc365_PickPlaceToasterToCounter_30k_b64_4frame_component_factored}"
...
echo "[i] use_component_factored_head=True (right_arm/right_hand/base + control_mode decoders)"
...
FACTORED_ARGS=(--use-component-factored-head)
MOTION_ARGS=()
