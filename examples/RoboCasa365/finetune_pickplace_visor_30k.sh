...
# with component-factored decoders + VISOR v2 (WWM+proprio+Conv1d, sparse tactile loss).
set -euo pipefail
...
OUTPUT_DIR="${OUTPUT_DIR:-$PROJECT_ROOT/output/rc365_PickPlaceToasterToCounter_30k_b64_4frame_visor_v2_r2}"
